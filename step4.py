...
#import policies that were selected in step 3
...
#putting imported policies in the right form for ema workbench
...
#defining amount of scenarios
    n_scenarios = 10000 # 10.000
    n_policies = policies_to_evaluate

#performing experiments: evaluate policy performance over scenarios
