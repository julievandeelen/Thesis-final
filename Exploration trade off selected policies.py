...
#importing the vensim model & defining the problem formulation
...
#in this case we want to explore a policy with no harvesting
    policies = [ Policy('Static policy zero',
                       model_file='model_thesis_static_zero.vpmx')]

#performing experiments for 10.000 scenarios and 1 policies
