...
#import the policies that were selected before
results_policies = pd.read_excel('./Data/filtered_policies.xlsx')

#defining the problem formulation & connecting to the vensim model
...
#putting the policies in the right form for the ema workbench
    policies_to_evaluate = []

    for i, policy in results_policies.iterrows():
        policies_to_evaluate.append(Policy(str(i), **policy.to_dict()))

#defining some parameters from the vensim model that are thought interesting to explore
...
#defining the amount of scenarios
