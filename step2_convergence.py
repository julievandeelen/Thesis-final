...
#importing the vensim model, defining the problem formulation, and performing experiments
if __name__ == "__main__":
    ema_logging.log_to_stderr(ema_logging.INFO )

#importing the vensim model
    wd = './Vensim models'
    vensimModel = MyVensimModel("simpleModel", wd=wd,
                               model_file='model_thesis.vpmx')#model_thesis.vpmx #model_thesis_V53_influence.vpmx
...
#putting the reference scenario in the right form for the workbench
...
#defining which convergence metrics you want to save
    convergence_metrics =[EpsilonProgress()]

#optimising the decision lever for the 5 outcomes, over 800.000 runs
